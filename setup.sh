...
main() {
    ...
    for step in "${steps[@]}"; do
        case "$step" in
        1) step_num=$((step_num + 1)); run_git ;;
        2) step_num=$((step_num + 1)); run_mirror ;;
        3) step_num=$((step_num + 1)); run_update ;;
        4) step_num=$((step_num + 1)); run_packages ;;
        5) step_num=$((step_num + 1)); run_ssh ;;
